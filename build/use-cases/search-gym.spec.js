...
// src/use-cases/search-gym.spec.ts
var gymRepository;
var sut;
describe("Search Gym Use Case", () => {
  ...
  it("Should be able to search gym", async () => {
    ...
    globalExpect(gyms).toEqual([globalExpect.objectContaining({ title: "JavaScript Gym" })]);
  ...
  it("Should be able to pagened search gym", async () => {
    ...
    globalExpect(gyms).toHaveLength(2);
