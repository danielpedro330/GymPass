...
var CheckInUseCases = class {
  constructor(checkInRepository, gymRepository2) {
    this.checkInRepository = checkInRepository;
    this.gymRepository = gymRepository2;
  }
...
describe("Check-in use case", () => {
  beforeEach(async () => {
    ...
    await gymRepository.create({
      ...
      description: "",
      phone: "",
      latitude: new import_library2.Decimal(-27.2092052),
      longitude: new import_library2.Decimal(-49.6401091)
    });
  });
  afterEach(() => {
    vi.useRealTimers();
  ...
  it("Should not be able to check in some on day", async () => {
    vi.setSystemTime(new Date(2e3, 0, 22, 8, 0, 0));
    await sut.execute({
      gym_id: "gym-1",
      user_id: "user-1",
      userLatitude: -27.2092052,
  ...
  it("Should be able to check in twice but in different day", async () => {
    ...
    vi.setSystemTime(new Date(2e3, 0, 23, 8, 0, 0));
    const { checkIn } = await sut.execute({
      user_id: "user-1",
      gym_id: "gym-1",
      userLatitude: -27.2092052,
  ...
  it("Should not be able to check in on distant gym", async () => {
    gymRepository.items.push({
      ...
      description: "",
      phone: "",
      latitude: new import_library2.Decimal(-27.0747279),
      longitude: new import_library2.Decimal(-49.4889672)
    });
