...
async function nearby(request, reply) {
  const nearbyGymsBodySchema = import_zod2.default.object({
    latitude: import_zod2.default.coerce.number().refine((value) => {
      return Math.abs(value) <= 90;
    }),
    longitude: import_zod2.default.coerce.number().refine((value) => {
